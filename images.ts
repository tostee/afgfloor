export const galleryImages: any[] = Array.from(
	{ length: 49 },
	(_, i: number) => ({
...
export const services = [
	{
		...
		images: Array.from(
			{ length: 6 },
			(_, i: number) => `/assets/images/services/HardwoodStairs/${i + 1}.jpg`
		),
	},
	{
		id: "2",
		...
		images: Array.from(
			{ length: 6 },
			(_, i: number) => `/assets/images/services/FloorMaintenance/${i + 1}.jpg`
		),
	},
	{
		id: "3",
		...
		images: Array.from(
			{ length: 6 },
			(_, i: number) => `/assets/images/services/LuxuryVinyl/${i + 1}.jpg`
		),
	},
];
