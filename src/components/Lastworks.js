      ...
      to="/gallery">
                ...
                <div className="lg:w-7/12 lg:mt-0 mt-8">
                    <div className="w-full h-full bg-red-200">
                        <img src="./assets/images/lastworks/1.png" alt="apartment design" className="w-full sm:block hidden" />
                        <img src="./assets/images/lastworks/2.png" alt="apartment design" className="sm:hidden block w-full" />
                    </div>
                    <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 lg:gap-8 gap-6 lg:mt-8 md:mt-6 mt-4">
                        <img src="./assets/images/lastworks/3.png" className="w-full" alt="kitchen" />
                        <img src="./assets/images/lastworks/4.png" className="w-full" alt="sitting room" />
                    </div>
                </div>
            </div>
        </div>
